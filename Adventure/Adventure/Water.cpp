...
Water::Water() {
	...
	exploreStory = "Walking around the pond...the waterskin turns out to be empty...but boy does that waterfall look beautiful.\nI'll bet that water could put out even the brightest fire.";
}
